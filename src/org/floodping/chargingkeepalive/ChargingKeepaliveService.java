...
public class ChargingKeepaliveService extends Service {

	private PowerManager.WakeLock wl = null;
	private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
		@Override
		public void onReceive(Context context, Intent intent) {
			ChargingKeepaliveService.this.onReceiveBtEvent(context, intent);
		}
	};
	...
	protected void onReceiveBtEvent(Context context, Intent intent) {
		...
		if (wl == null) {
			...
			wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK,
					"org.floodping.chargingkeepalive.ChargingKeepaliveService");
			if (wl == null) {
				return;
			}
		}
		...
		if (Intent.ACTION_POWER_CONNECTED.equals(action)) {
			...
			if (!wl.isHeld()) {
		      ...
		      Intent newIntent = new Intent(this, ChargingKeepaliveActivity.class);

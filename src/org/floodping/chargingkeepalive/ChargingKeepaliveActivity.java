...
public class ChargingKeepaliveActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (bAutorun && !bByNotification) {
			mHandler.postDelayed(new Runnable() {
				public void run() {
					ChargingKeepaliveActivity.this.finish();
				}
			}, 2000);
  ...
  public void RecheckProgressLater() {
    if(mHandler != null)
    {
      mHandler.postDelayed(new Runnable() {
        public void run() {
          ChargingKeepaliveActivity.this.UpdateProgress(true/*bRecheck*/);
        }
      }, 2000);
    }
  }
  ...
  public void UpdateProgress(boolean bRecheck) {
	...
	public void StartService(View view) {
		...
		serviceIntent
				.setAction("org.floodping.chargingkeepalive.ChargingKeepaliveService");
